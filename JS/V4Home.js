...
document.querySelector(".TOPmessagePopUpCLOSE").addEventListener("click", () => {
    document.querySelector(".TOPmessagePopUp").style.display = "none";
});


const btn = document.querySelector(".TOPmessagePopUpCLOSE");
const popup = document.querySelector(".TOPmessagePopUp");
...
// begin fullpagepopup full page pop up//
...
// show fullpagepopup full page pop up WHEN CLICKING ON FUTURE STORE LINKS//
document.querySelectorAll(".storeLink").forEach(link => {
...
// CLOSE  fullpagepopup full page pop up WHEN CLICKING ON RED X IN POP UP WINDOW//
document.querySelector(".fullPagePopUpClose").addEventListener("click", () => {
...
// END fullpagepopup full page pop up//
